...
def main() -> int:
    ...
    if "FROZEN_V165_TIMEBASE_BUILDER_BLOB = \"62d67becb768e1e5e3e8de1cd3b121eb863b2a18\"" not in sources["timebaseBuilder"]:
        failures.append("timebase builder predecessor pin missing")
    if "FROZEN_V165_TIMEBASE_QC_BLOB = \"3c11a490d24d06647894ee8c3700d9ff7decd993\"" not in sources["timebaseQc"]:
    ...
    for needle in (
        "constantTimeEquivalence",
        "boundaryClipping",
        "singleTransientDilution",
        "runtimeTemplatePatched",
    ):
    ...
    result = {
        "schema": "dadrock.tabs.v166.negative-runtime-guard.v1",
