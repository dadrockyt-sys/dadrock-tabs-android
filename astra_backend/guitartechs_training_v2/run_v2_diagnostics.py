...
def main():
    ...
    if development["sourceRun"]["runId"] != SOURCE_RUN_ID or development["decision"]["status"] != "FAIL":
        raise RuntimeError("unexpected frozen V2 development result identity")
    ...
    result = {
        "schema": "astra-guitar-techs-v2-error-decomposition-v1",
        "date": "2026-09-22",
        "sourceRunId": SOURCE_RUN_ID,
        "candidateId": CANDIDATE_ID,
        "evidenceBoundary": "P1/P2 development evidence only; P3 remained sealed.",
        "metricSemantics": {
            "frozenVerdictUnchanged": True,
    ...
    print("V2_ERROR_DECOMPOSITION_PASS")
    print(json.dumps({
        "sourceRunId": SOURCE_RUN_ID,
        "folds": {k: {
