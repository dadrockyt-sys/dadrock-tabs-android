...
from guitartechs_training_v3.train_v3_resumable import _infer_v3

CANDIDATE_ID = "astra_guitartechs_tabcnn_v3_objective_decoder"
SOURCE_RUN_ID = 35808420395
...
def main():
    ...
    if development["sourceRun"]["runId"] != SOURCE_RUN_ID or development["decision"]["status"] != "FAIL":
        raise RuntimeError("unexpected frozen V3 development result identity")
    ...
    result = {
        "schema": "astra-guitar-techs-v3-error-decomposition-v1",
        "date": "2026-09-23",
        "sourceRunId": SOURCE_RUN_ID,
        "candidateId": CANDIDATE_ID,
        "evidenceBoundary": "P1/P2 development evidence only; P3 remained sealed.",
        "metricSemantics": {
            "frozenVerdictUnchanged": True, "decoder": "frozen V3 confidence/hysteresis decoder",
        ...
        "sourceIdentities": {
            ...
            "decoderSourceGitBlob": "87e127c87851ea9a43b9a9e6240f1a7c4624424b",
            "v3TrainerGitBlob": "464293f9a7c8fdfe1feb76460c5c370900fc1d53",
        },
        "folds": fold_out,
        "aggregate": aggregate,
        "guards": {
    ...
    print("V3_ERROR_DECOMPOSITION_PASS")
    print(json.dumps({
        "sourceRunId": SOURCE_RUN_ID,
        "folds": {k: {
