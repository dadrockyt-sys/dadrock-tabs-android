...
OUTPUT_PATH = PUBLIC / "gomyway-1448-periodicity-survivor-additions-precision-v1.json"
MANIFEST_PATH = PUBLIC / "gomyway-1448-periodicity-survivor-additions-precision-v1-manifest.json"
...
def main() -> None:
    ...
    survivor_payload = v2.load_json(PROFILE_1444_PATH)
    ...
    for row in remaining_rows:
        ...
        details.append({**row, "survives1448Prune": True, "trueSurvivorAddition": truth == "true"})
    ...
    if before != after:
        raise RuntimeError("Protected candidate changed during 14.48 survivor profiler")

    output = {
        "schemaVersion": 1,
        "passed": True,
        "profileType": "validated-14.48-periodicity-survivor-additions-precision",
        "champion1448Score": score_1448,
        "validatedSecondPruneRule": "survivor_prune_union_a_b_c_d",
        ...
        "recommendedNextAction": "benchmark-only-repeatable-zero-precision-14.48-survivor-prunes-with-prune-specific-heldout-cv",
    }
    manifest = {
        "schemaVersion": 1,
        "passed": True,
        ...
        "championPitchF1": score_1448["pitchF1"],
        "survivorAdditionCount": len(remaining_rows),
    ...
    print("GOMYWAY 14.48 PERIODICITY SURVIVOR ADDITIONS PRECISION V1 COMPLETE")
    print("Passed: True")
    print("Champion pitch F1:", score_1448["pitchF1"])
    print("Champion matched/missing/extra:", score_1448["matched"], "/", score_1448["missing"], "/", score_1448["extra"])
