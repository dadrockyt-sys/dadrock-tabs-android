...
import benchmark_gomyway_1328_champion_section_step_pitch_score_agreement_gate_v1 as gate1345

p1328 = gate1345.p1328
finer = p1328.finer
...
PUBLIC = ROOT / "public"
OUTPUT_PATH = PUBLIC / "gomyway-1345-champion-finer-cross-signatures-v1.json"
MANIFEST_PATH = PUBLIC / "gomyway-1345-champion-finer-cross-signatures-v1-manifest.json"
...
def main() -> None:
    ...
    print("Rebuilding frozen validated 9.29 core and 13.45 champion for deeper residual profiling...", flush=True)
    ...
    if before != after:
        raise RuntimeError("Protected candidate changed during 13.45 finer cross-signature profiler")

    output = {
        "schemaVersion": 1,
        "passed": True,
        "benchmarkType": "validated-13.45-champion-finer-residual-cross-signature-profile",
        ...
        "recommendedNextAction": "design-next-finer-cross-signature-prune-from-validated-13.45-profile",
    }
    manifest = {
        "schemaVersion": 1,
        "passed": True,
    ...
    print("GOMYWAY 13.45 CHAMPION FINER CROSS-SIGNATURE PROFILE V1 COMPLETE")
    print("Passed: True")
