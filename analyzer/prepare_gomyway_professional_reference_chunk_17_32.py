...
OUTPUT = ROOT / "public" / "gomyway-professional-rhythm-reference-chunk-17-32.json"
AUDIT = ROOT / "public" / "gomyway-professional-rhythm-reference-chunk-17-32-audit.json"
...
def main() -> None:
    ...
    audit = {
        ...
        "humanValidatedMeasures": sum(
            1 for item in prepared if item["humanReview"]["status"] == "approved"
        ),
        "measuresWithEvents": sum(1 for item in prepared if item.get("events")),
        "readyForTraining": False,
        "nextRequiredStage": "populate-and-human-validate-measures-17-32",
        "protectedBaselinesChanged": False,
    }
    AUDIT.write_text(json.dumps(audit, indent=2) + "\n", encoding="utf-8")

    print("Professional rhythm reference chunk 17-32 prepared")
