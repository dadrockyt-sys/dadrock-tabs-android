...
# V29's candidate diagnostics call path_metrics through its V26 module
# reference. The helper actually lives in V23, reached from V25 through
# V24. Patch only that missing diagnostic reference; do not alter scoring.
v30 = previous.previous
v29 = v30.previous
v25 = v29.v25
v26 = v29.previous.previous.previous
v23 = v25.previous.previous
v26.path_metrics = v23.path_metrics
...
def analyze_audio_file(audio_path: str, transcription_type: str) -> dict[str, Any]:
    ...
    result["engineVersion"] = "3.3-phase-1-diagnostics-safe"
    result["guitarBrainLesson"] = "harmony-first-with-stable-candidate-diagnostics"
    return result
