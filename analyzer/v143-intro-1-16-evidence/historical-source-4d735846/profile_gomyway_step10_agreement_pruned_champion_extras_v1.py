...
OUTPUT_PATH = PUBLIC / "gomyway-step10-agreement-pruned-champion-extras-profile-v1.json"
MANIFEST_PATH = PUBLIC / "gomyway-step10-agreement-pruned-champion-extras-profile-v1-manifest.json"
...
def main() -> None:
    ...
    print("Rebuilding frozen validated 9.04 step10-agreement champion...", flush=True)
    ...
    if candidate_hash_before != candidate_hash_after:
        raise RuntimeError("Protected candidate changed during 9.04 extras profile.")

    output = {
        "schemaVersion": 1,
        "passed": True,
        "benchmarkType": "validated-9.04-step10-agreement-pruned-champion-extra-profile",
        "championScore": full,
        ...
        "recommendedNextAction": "design-fifth-stage-precision-pruning-from-validated-9.04-cross-signatures",
    }
    manifest = {
        "schemaVersion": 1,
        "passed": True,
    ...
    print("GOMYWAY STEP10-AGREEMENT PRUNED CHAMPION EXTRAS PROFILE V1 COMPLETE")
    print("Passed: True")
