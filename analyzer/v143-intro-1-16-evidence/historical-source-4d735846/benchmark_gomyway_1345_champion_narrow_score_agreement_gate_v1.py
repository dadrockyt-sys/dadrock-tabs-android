...
import profile_gomyway_1345_champion_finer_cross_signatures_v1 as p1345

p1328 = p1345.p1328
gate1345 = p1345.gate1345
gate1328 = p1345.gate1328
p1316 = p1345.p1316
v2 = p1345.v2
v3 = p1345.v3
recall = p1345.recall
...
PUBLIC = ROOT / "public"
OUTPUT_PATH = PUBLIC / "gomyway-1345-champion-narrow-score-agreement-gate-v1.json"
MANIFEST_PATH = PUBLIC / "gomyway-1345-champion-narrow-score-agreement-gate-v1-manifest.json"
EXPECTED_CORE = (102, 765, 1227)
EXPECTED_CHAMPION = (172, 695, 1518)
EXPECTED_F1 = 13.45
WINNER_NAME = "dual6_quarter_40_64"

TARGET_SIGNATURES = {
    "m65_80_step0_midi54_score10_13_single_or_weak",
    "m65_80_step12_midi49_score24_plus_both10",
    "m65_80_step12_midi51_score16_20_both10",
    "m65_80_step12_midi52_score8_10_single_or_weak",
    "m65_80_step4_midi52_score_lt8_single_or_weak",
    "m65_80_step8_midi52_score13_16_both10",
    "m81_96_step0_midi50_score8_10_single_or_weak",
    "m81_96_step0_midi64_score8_10_single_or_weak",
    "m81_96_step12_midi64_score10_13_both10",
    "m81_96_step12_midi64_score8_10_single_or_weak",
    "m81_96_step4_midi45_score_lt8_single_or_weak",
    "m81_96_step4_midi52_score8_10_single_or_weak",
    "m81_96_step4_midi57_score13_16_single_or_weak",
    "m81_96_step4_midi57_score8_10_single_or_weak",
    "m97_113_step0_midi57_score8_10_single_or_weak",
    "m97_113_step4_midi52_score8_10_single_or_weak",
    "m97_113_step8_midi52_score16_20_both10",
}

RULES = [
    {"name": "drop_" + sig, "drop": {sig}} for sig in sorted(TARGET_SIGNATURES)
] + [
    {"name": "drop_all_profiled_narrow_score_agreement_zero_precision", "drop": TARGET_SIGNATURES}
]
...
def signature(token, winner_scores, alt_scores) -> str:
    ...
    band = p1345.narrow_score_band(max_score)
    agreement = "both10" if ws >= 10 and als >= 10 else "single_or_weak"
    return f"{p1345.section_for(int(measure))}_step{step}_midi{pitch}_{band}_{agreement}"
...
def main() -> None:
    ...
    print("Rebuilding frozen validated 9.29 core and 13.45 champion for narrow-score gate...", flush=True)
    ...
    if actual != EXPECTED_CHAMPION or abs(float(champion_score["pitchF1"]) - EXPECTED_F1) > 0.01:
        raise RuntimeError(f"Expected 13.45 champion {EXPECTED_CHAMPION}/{EXPECTED_F1}, got {actual}/{champion_score['pitchF1']}")
    ...
    if accepted:
        ...
        winner_name, winner = "retain_13_45_champion", {
    ...
    if before != after:
        raise RuntimeError("Protected candidate changed during 13.45 narrow-score benchmark")

    ws = winner["fullScore"]
    validated = winner_name != "retain_13_45_champion"
    output = {
        "schemaVersion": 1,
        "passed": True,
        "benchmarkType": "validated-13.45-section-step-pitch-narrow-score-agreement-gate",
        ...
        "recommendedNextAction": "profile-next-finer-cross-signatures-from-validated-winner" if validated else "retain-13.45-and-test-next-finer-family",
    }
    manifest = {
        "schemaVersion": 1,
        "passed": True,
    ...
    print("GOMYWAY 13.45 CHAMPION NARROW-SCORE AGREEMENT GATE V1 COMPLETE")
    print("Passed: True")
