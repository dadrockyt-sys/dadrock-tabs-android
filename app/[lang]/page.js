...
export async function generateMetadata({ params }) {
  ...
  const titles = {
    ...
    'pt-br': 'DadRock Tabs - Cifras e Tablaturas Grátis de Guitarra e Baixo | Rock Clássico Anos 70 80 90',
  ...
  const descriptions = {
    ...
    'pt-br': 'Aprenda guitarra, violão e baixo com cifras e tablaturas grátis de rock clássico, heavy metal e blues. Para iniciantes e avançados. Led Zeppelin, AC/DC, Van Halen, Metallica, Black Sabbath e mais lendas do rock dos anos 70 80 90. Vídeo aulas de guitarra elétrica e violão.',
  ...
  const keywords = {
    ...
    'pt-br': 'cifras guitarra grátis, tablaturas guitarra, cifras violão, rock clássico cifras, heavy metal tabs, blues guitarra, rock anos 70 80 90, Led Zeppelin cifras, AC/DC cifras, Van Halen, Metallica, Black Sabbath, aulas guitarra elétrica, vídeo aulas violão, aprender guitarra, baixo cifras',
