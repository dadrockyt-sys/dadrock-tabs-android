...
## 2026-09-01 continuation checkpoint — Codespace arm preflight normalization mismatch
- The exact frozen private SplitMySong source reached the Codespace arm preflight after the CPU environment passed. The arm gate failed closed before any inference because the generated normalized WAV SHA256 was **`7717939de51bbb3cafab85427fd8273411935ca03848823d326d8bf4effacfd6`**, while the previously frozen local normalized WAV SHA256 is **`fdb0578d71f77c150e7fe66766a03953be55e7028fef4c24dc777416f2e7ff4f`**.
- No candidate was generated and no Basic Pitch inference, scorer, or reference access occurred. This is a normalization reproducibility issue only; V168 prospective score calls remain 0.
- The original frozen normalization was reproduced again in the private local sandbox using system FFmpeg **7.1.5**, yielding the same WAV SHA256 `fdb0578d...e7ff4f` and 9,572,600 bytes. Its decoded/raw 22.05 kHz mono S16LE PCM SHA256 is **`2c5dc122c2d37e562d90a13eac0c6dcac534ad7ee562fecd154b98e9124f63dd`**.
- Added reference-blind diagnostic `validation/v168_splitmysong_diagnostic/diagnose_normalization_v168.sh` at commit **`61195e6571b49c683dfd3a45bfb9ca77b5e8a065`**. It verifies the exact private source SHA, prints the Codespace system FFmpeg version, generates the same normalization, compares WAV and raw-PCM identities, and classifies the discrepancy as exact match, WAV-wrapper-only difference, or actual PCM difference.
- Do not weaken or edit the frozen arm gate yet. First run the new normalization diagnostic in the Codespace against the private source. If PCM matches `2c5dc122...4f63dd`, the issue is container/header byte identity; if PCM differs, the execution environment must be updated to reproduce the frozen FFmpeg 7.1.5 PCM before arm can pass.
- No audio/reference bytes were committed. No GPU/CUDA/Modal, `main`, Production, V168 policy/scorer/validator mutation, or holdout scoring occurred. **Project Progress Score remains 60%; Test Score remains NOT RUN.**

## 2026-09-01 continuation checkpoint — SplitMySong FFmpeg normalization correction verified
- The private Codespace normalization diagnostic classified the first arm-preflight failure as **`PCM_DIFFERENCE`**, not a WAV-wrapper-only difference. The exact frozen source SHA256 still matched `6601b8d01cbbbe6b6e70d9ec0ca3c15d17873c78e62ae4acdc258c96f168e3c9`.
- The old Codespace was Debian 12 / FFmpeg **5.1.9-0+deb12u1**. It produced normalized WAV SHA256 `7717939de51bbb3cafab85427fd8273411935ca03848823d326d8bf4effacfd6` and raw PCM SHA256 **`fe8fd3d83600027afd0827cee6eb821371a3b3ce3a8907fd761be345a94538f3`**, which differs from the frozen raw PCM SHA256 **`2c5dc122c2d37e562d90a13eac0c6dcac534ad7ee562fecd154b98e9124f63dd`**.
- Root cause is therefore decoder/resampler environment drift. The frozen normalization was produced/reproduced with Debian 13 (`trixie`) FFmpeg package **`7:7.1.5-0+deb13u1`**; the arm gate correctly failed before pitch inference.
- Updated `validation/v168_splitmysong_diagnostic/Dockerfile.cpu` to `python:3.10.21-slim-trixie` and exact `ffmpeg=7:7.1.5-0+deb13u1`. Current Dockerfile blob is **`2c67c375bac79b983474cb641a02c3e8d78b8ac0`**.
- Added fail-closed no-audio verifier `validation/v168_splitmysong_diagnostic/verify_ffmpeg_normalizer_v168.py`, current blob **`c72dcb121405b0211d6b64f91d33c3de2d5de09a`**. It requires Debian 13, exact dpkg FFmpeg version `7:7.1.5-0+deb13u1`, and matching FFmpeg binary version before arm can proceed.
- `codespace_status.sh` now runs the exact FFmpeg verifier before the frozen CPU/model/repository verifier; current blob **`434599bf4aab5db0e72e0b3923c46db089072ee7`**.
- `run_private_arm_preflight.sh` now runs the exact FFmpeg verifier before environment verification and audio normalization; current blob **`7f22cd3832f7d2e64d05da6996edc93d6d1982ad`**.
- The no-audio GitHub Actions workflow `V168 SplitMySong CPU environment smoke` was extended to build the corrected image and separately verify the exact FFmpeg normalizer plus the CPU/reference-blind environment. Run **33555154045**, job **100014047776**, head commit **`7efef8a230567d97abfa2dfea889454fcef79591`**, completed **SUCCESS**: image build PASS, exact FFmpeg normalizer PASS, CPU/reference-blind environment PASS.
...
## 2026-09-01 continuation checkpoint — SplitMySong reference-blind generator frozen
- The private Codespace ARM gate is already frozen **PASS**; candidate generation had not run when this generator checkpoint was created.
- Dedicated one-shot reference-blind generator: `validation/v168_splitmysong_diagnostic/generate_splitmysong_candidate_v168.py`, creation commit **`79f3847bc54c6d95ee8166c742d9c6ec9e6efe67`**, frozen Git blob **`95972fb9b1f9c1bf4872e2c945025b4aa69a312c`**.
- Private one-command generation launcher: `validation/v168_splitmysong_diagnostic/run_private_candidate_generation.sh`, creation commit **`3c162e30ca51680ab00f41522f9c3b42348704b2`**, frozen Git blob **`ff0abb9d979cb475862278ffc17966e6d73f5a86`**.
- Static safety workflow: `.github/workflows/v168-splitmysong-generator-static.yml`, creation commit **`94710f77ee3d00e1e79c985b5ab72bc721135189`**, Git blob **`fb576039ab33349c5420454ce6a840331f6bf5f3`**. Run **`33560121176`** completed **SUCCESS**. It compiled the generator, syntax-checked the launcher, pinned both blob identities, verified the CLI accepts exactly `--repo-root`, `--source`, `--normalized-guitar`, `--arm-receipt`, `--environment-receipt`, `--ffmpeg-receipt`, and `--output-dir`, and confirmed no scorer/reference CLI argument is accepted.
- Generator pins the private SplitMySong source SHA256 **`6601b8d01cbbbe6b6e70d9ec0ca3c15d17873c78e62ae4acdc258c96f168e3c9`**, normalized Guitar SHA256 **`fdb0578d71f77c150e7fe66766a03953be55e7028fef4c24dc777416f2e7ff4f`**, ARM receipt SHA256 **`f34aef34a729d4ca32ba42975717a1b8e79b568aa1a8dc44d13c2eb1bcd6ef6f`**, CPU environment receipt SHA256 **`c7bf81f59220808cef01a7e399830dbf8a23df4b052fac10bac75c498ad78847`**, FFmpeg receipt SHA256 **`e7713b47a4f3bf468b706bb0eef8c683ea3e2ec3571e3170f203e28bf9ee1f1f`**, Basic Pitch model SHA256 **`3db297d54af8e01c6e5618245c956b1d71b6a2b978cb2dedb527173186552676`**, frozen V166 timebase, exact V166/V167 code blobs, and exact `gss-active-only` config.
- Clean A/B definition is frozen: historical AYGGMW mix/drums/bass/timebase context is reproduced and hash-verified; the only changed front-end input is the Guitar audio, replaced by the externally separated SplitMySong Guitar. The candidate then follows V166 Guitar front-end/grid mapping, V167 global phase `-12`, frozen `max_score_x_shared` step rule, and frozen I005 `gss-active-only` recovery.
- The generator caches Basic Pitch so the candidate path requires **exactly one actual Basic Pitch inference call**. It writes an irreversible one-shot attempt marker immediately before entering the candidate-building inference path; pre-existing marker/candidate/receipt/freeze files make rerun fail closed.
- Successful generation writes only private files: `splitmysong-i005-candidate.json`, `splitmysong-generation-receipt.json`, and `splitmysong-candidate-freeze.json`. The freeze status is `FROZEN_BEFORE_ANY_LEGACY_REFERENCE_OR_SCORER_ACCESS`; the launcher explicitly stops after printing their SHA256 values and does not invoke a scorer.
- Added a separate **no-pitch-inference** historical-context preflight to reduce execution risk before consuming the one-shot inference attempt: `validation/v168_splitmysong_diagnostic/prepare_historical_context_v168.py`, creation commit **`f44def1823927866da3b7fa2c9f1f5b52ea5e942`**, Git blob **`b93d8e671858c8b433c6e6645dc9f0e826429ed3`**. It reproduces and verifies historical source/mix plus exact Demucs `htdemucs_6s` Guitar/Bass/Drums hashes without importing Basic Pitch, generating a candidate, or opening scorer/reference content.
- Private historical-context launcher: `validation/v168_splitmysong_diagnostic/run_historical_context_preflight.sh`, creation commit **`e87c97a2036849f2fad8bdf4c31a95c32bb2872b`**, Git blob **`03c315e4cbfd84b30255976dad39bf3a7f0caf13`**.
- **Next safe action is the no-inference historical-context preflight only.** Require `HISTORICAL CONTEXT PREFLIGHT PASS` and record its private receipt SHA256 before executing the one-shot candidate launcher.
- At this checkpoint: **no diagnostic candidate has been generated, no Basic Pitch inference has run for SplitMySong, no scorer/reference has been opened, and diagnostic reference-facing score calls remain 0**. V168 prospective evaluation remains untouched: **Project Progress Score 60%; Test Score NOT RUN; V168 reference-facing score calls 0**. No GPU/CUDA/Modal, `main`, or Production change occurred.

## 2026-09-01 continuation checkpoint — SplitMySong context preflight + one-shot generator code frozen
- The private SplitMySong ARM gate was already frozen at commit `fb1f773683e1f16e0279f828ab49d2ab2f03e1e8` with status **ARM PREFLIGHT PASS** and no pitch inference/candidate/scorer/reference access.
- Added no-inference historical-context preflight `validation/v168_splitmysong_diagnostic/prepare_historical_context_v168.py`, Git blob **`b93d8e671858c8b433c6e6645dc9f0e826429ed3`**. It reproduces the exact historical AYGGMW source from frozen repo history, the exact imageio-ffmpeg normalized mix, and deterministic CPU `htdemucs_6s` stems; all historical mix/Guitar/Bass/Drums/timebase identities are hash-checked. It explicitly performs no Basic Pitch inference and reads no scorer/reference.
- Added private context-preflight launcher `validation/v168_splitmysong_diagnostic/run_historical_context_preflight.sh`, Git blob **`03c315e4cbfd84b30255976dad39bf3a7f0caf13`**. It first reruns the full Codespace CPU/FFmpeg status gate, pins the context-preflight blob, and writes only under `$HOME/v168-splitmysong-private/historical-context`.
- Frozen generation core `validation/v168_splitmysong_diagnostic/generate_splitmysong_candidate_v168.py`, Git blob **`95972fb9b1f9c1bf4872e2c945025b4aa69a312c`**. This contains the exact V166→V167/I005 front-end and one-call Basic Pitch logic, but **must not be executed directly**.
- Added final one-shot wrapper `validation/v168_splitmysong_diagnostic/generate_from_frozen_context_v168.py`, Git blob **`d425feffbcde1130fd2b98cfccc3aa1dc29db468`**. The wrapper accepts only private source/normalized audio/receipts, frozen historical context, repo root, and private output. It exposes no scorer/reference input. It verifies the frozen generator-core blob and all context identities before creating the persistent one-shot inference marker.
- The clean A/B definition is frozen: historical source normalization, original mix, original Demucs context, frozen V166 timebase, V167 global -12 phase, I002 `max_score_x_shared`, and exact I005 `gss-active-only` logic remain fixed; **only the Guitar audio is replaced by the frozen SplitMySong isolated Guitar**.
- The final wrapper reuses the separately frozen historical context, so Demucs/model acquisition or context reproducibility cannot consume the sole Basic Pitch attempt. After context verification, exactly one Basic Pitch inference is allowed; the cached raw notes feed both V166 Guitar generation and the reference-blind I005 upstream pitch-evidence pool.
- Updated smoke workflow `.github/workflows/v168-splitmysong-environment-smoke.yml`, Git blob **`47619d754d6e42a734a76fd1dad740c2fc51dc92`**. GitHub Actions run **`33560475990`** at head **`f47be8bca1d88c20cb62246be8066631ccc0fbc2`** completed **SUCCESS**: exact CPU image build PASS, exact FFmpeg 7.1.5 normalizer PASS, CPU/reference-blind environment PASS, Python compilation PASS, shell syntax PASS, and no reference/scorer CLI argument exposed.
- Smoke run `33560475990` used no private SplitMySong audio, invoked no Basic Pitch inference, generated no candidate, and read no scorer/reference.
- **Candidate generation is still NOT RUN and remains unarmed for the user.** Next safe step is only the private historical-context preflight. After that PASS, record its exact private receipt SHA256 in this checkpoint, then create/freeze a tiny generation launcher that pins that receipt SHA plus the final-wrapper/core Git blobs. Only after that second checkpoint may the one-shot Basic Pitch inference command be given.
- No GPU/CUDA/Modal, `main`, Production, V168 policy/scorer/validator, or prospective holdout state changed. **Project Progress Score remains 60%; Test Score remains NOT RUN; V168 reference-facing score calls remain 0.**

## 2026-09-01 continuation checkpoint — historical Demucs context mismatch caught before inference
- The private Codespace ran the frozen no-Basic-Pitch historical-context preflight after the generator freeze checkpoint. Demucs completed separation, then the gate failed closed while verifying the historical Guitar stem.
- Exact observed Codespace Guitar stem SHA256: **`a1213a0b9d32982d18c1a66f85441a942e16aef0400dc13dca2eedba1dda4b28`**.
- Frozen expected historical Guitar stem SHA256 remains **`4c71e9e15dd07e60a5442923b86523bafe4313056ca3c892054a607aa7e4e9d2`**. The expected identity has **not** been weakened or changed.
- Failure occurred inside `prepare_historical_context_v168.py` during stem SHA verification and explicitly before any SplitMySong Basic Pitch inference. No diagnostic candidate, scorer/reference access, or reference-facing score call occurred; the one-shot Basic Pitch attempt remains unconsumed.
- Historical V165 successful generation lineage was rechecked. The historical workflow used Python 3.10.21, `demucs==4.1.0`, Torch `2.8.0+cpu`, deterministic seeds/algorithms, `htdemucs_6s`, CPU, `--shifts 1`, `-j 1`, and the same byte-frozen normalized historical mix. The current diagnostic environment resolves the same top-level Demucs/Torch versions and the same Demucs invocation.
- Public Demucs metadata confirms `htdemucs_6s` maps to model signature `5c90dfd2`; the canonical checkpoint filename is `5c90dfd2-34c22ccb.th`, whose published SHA256 is `34c22ccb381c6f9fdbf324f04e1e2fe21aaf293f5ded163a162697ff9a02ddd`. Model/cache byte identity in the failed Codespace must be measured before attributing the stem mismatch to model drift versus execution-platform floating-point behavior.
- Added read-only/no-inference diagnostic `validation/v168_splitmysong_diagnostic/diagnose_historical_context_failure_v168.py` at commit **`19120df0ddea2cd7d8edfdc68b31b2a2f096edab`**. It reads only the already-failed private `.building` directory and local model caches, hashes the mix and all available Demucs stems plus matching `5c90dfd2` model files, reports relevant package/runtime identities, and does **not** invoke Demucs, Basic Pitch, scorer, or reference access.
- Preserve `/root/v168-splitmysong-private/historical-context.building` until the diagnostic output is captured. Do not delete it and do not rerun the context preflight yet.
- Next safe action: pull the branch and run the read-only historical-context failure diagnostic against the existing `.building` directory. Use its model/stem hashes to decide whether to pin/recover model bytes or reproduce the historical Ubuntu 24.04 execution platform. Do not run the one-shot candidate generator until historical context reaches exact PASS.
- **Project Progress Score remains 60%; Test Score remains NOT RUN; SplitMySong Basic Pitch attempts remain 0; diagnostic/V168 reference-facing score calls remain 0.** No GPU/CUDA/Modal, `main`, or Production change occurred.

## 2026-09-01 continuation checkpoint — exact V166 Demucs replay still byte-divergent
- Replayed the authoritative V166 historical Demucs stage on GitHub Actions without private SplitMySong audio, Basic Pitch inference, candidate generation, scorer/reference access, or artifacts. Replay workflow commit: `c423547214989092855fe6a4e63fb4df0fccf12c`; run **`33562935451`**, job **`100039447509`**.
- The replay matched the authoritative V166 execution surface that was recoverable from run `33226705813` / job `99031747626`: Ubuntu 24.04.4 runner image `20260823.283.1`, Python `3.10.21`, Torch `2.8.0+cpu`, CUDA unavailable, exact historical source bytes, exact normalized mix SHA256 **`3e61b7926eabc21b758c750f826c7426a29d6de5aafdd5c93f8045ecdc67f87e`**, Demucs `4.1.0`, `htdemucs_6s`, CPU, `--shifts 1`, `-j 1`, deterministic algorithms and one-thread math.
- The second replay additionally restored the two resolver versions that had drifted since Aug 29 — `joblib==1.5.3` and `platformdirs==4.11.5` — and removed `cloudpickle`, which was absent from the successful V166 environment. The historical dependency-resolution guard passed before separation.
- Hugging Face model identity also matched: `adefossez/HTDemucs-6s`, snapshot **`3c5ee475be622df764938de97e4281a7b07ffa58`**, `htdemucs_6s.yaml` SHA256 **`207405151270af8fd81c2373c25d27950916682ac91dca7884a11ce13dad6f58`**, and `5c90dfd2.safetensors` SHA256 **`d2a1745f0744721f6b8ca5bf469b67c651ea5ed1b52998cab033b2158609d411`**.
- Despite those matches, fresh exact-transitive stem bytes remained different. Replay Guitar SHA256 **`b8685062c59f5c62253029f8294afdaf25f3f8adf8868ae97b47db09ab8838f9`**, Bass **`f109347354dd9ae4a293189834b1f6d58199a4eebe5d51dfeeedc6707c4a5316`**, Drums **`7ef184f2fc3b6f7fc12ea5c342bc537f6b69f1680ce36e9d4f7189be85d93e39`**. The frozen authoritative V166 hashes remain unchanged: Guitar **`4c71e9e15dd07e60a5442923b86523bafe4313056ca3c892054a607aa7e4e9d2`**, Bass **`4b34b2bc3367d9f8ed4dce39b95ad3d60c49d6541186df6b0d24a4211b03c7ef`**, Drums **`05890ac9cad62eacf0099c962b137a458228811a85b8ea828bb15f238d2c1e50`**.
- Current replay CPU was `AMD EPYC 7763 64-Core Processor`; the Aug-29 V166 log did not print its CPU model. Therefore hardware-dependent floating-point behavior is now a strong hypothesis but is **not claimed proven**.
- Important scope correction: SplitMySong diagnostic candidate construction consumes historical **mix + drums** for the shared onset context and the frozen V166 timebase; historical Demucs Guitar/Bass are not candidate inputs. The frozen shared onset formula is `unit_norm(0.65 * onset_env(drums) + 0.35 * onset_env(mix))`.
- Next safe research step is a **no-Basic-Pitch downstream timing-equivalence diagnostic**. Using the frozen V166 candidate's persisted `stepSelection` rows, recompute current shared supports from a fresh drifted Drums stem while retaining each historical event's frozen instrument supports, then compare frozen-vs-current selected grid steps and support differences. This tests whether byte-level stem drift actually changes the timing decision surface used by V166 without reading any professional reference or scorer.
- Do **not** weaken the frozen historical stem hashes and do not run the one-shot SplitMySong candidate generator yet. The failed private Codespace `.building` directory remains preserved for read-only diagnosis.
- **Project Progress Score remains 60%; Test Score remains NOT RUN; SplitMySong Basic Pitch attempts remain 0; diagnostic/V168 reference-facing score calls remain 0.** No GPU/CUDA/Modal, `main`, or Production change occurred.



## 2026-09-01 continuation checkpoint — shared-context functional-equivalence result
- Before execution, added isolated reference-blind checker `validation/v168_splitmysong_diagnostic/check_shared_context_equivalence_v168.py`, creation commit **`73af04264c13e5daddb5b7fc1db4e0bd9dcea149`**, frozen Git blob **`2e9a8dc2ec60a311b3e6bca5f8dc9390aea48b0f`**. Its acceptance rule was fixed in code before the diagnostic result was observed.
- Exact V166 Actions run `33226705813` s no surviving uploaded artifacts, and historical `.github/workflows/v166-generate.yml` at head `1e06d775ee03ebf92fe8f68fc02cf034812ea43f` contains no `upload-artifact` or persistent stem-cache step. The authoritative historical Demucs Drums WAV bytes therefore cannot currently be recovered from that run.
- Frozen V166 identities used by the checker: candidate SHA256 **`fa2411598b401f745eff49a9cbda294ed767de093c905909531c7dd4dc6eb378`**, timebase SHA256 **`899746d3048d239bc0032375d412a109ea04b055df19df1b7b08dc3e73aa5ca0`**, normalized mix SHA256 **`3e61b7926eabc21b758c750f826c7426a29d6de5aafdd5c93f8045ecdc67f87e`**, 1050 combined-Guitar events, 402 Bass events, 1805 lattice steps.
- Frozen checker acceptance: PASS requires **all 1805 lattice steps covered by historical persisted option rows**, zero inconsistent repeated historical shared-support values, zero stored historical score recomputation mismatches, zero frozen winner recomputation mismatches, and zero current selected-step changes. Incomplete coverage must return `FAIL_CLOSED` even if all observed event decisions agree. The checker does not claim WAV-byte equivalence.
- GitHub Actions diagnostic workflow `.github/workflows/v168-shared-context-equivalence.yml` run **`33564860461`**, job **`100045591125`**, head **`58342c8c5cc63b945fb4d56c658f47015d0a9ce6`**, completed successfully as an execution workflow; the scientific checker itself returned **`OBSERVED_EVENT_NEIGHBORHOODS_EQUIVALENT_BUT_LATTICE_COVERAGE_INCOMPLETE / FAIL_CLOSED`** with exit code 2 as preregistered.
- Fresh drifted Drums SHA256 in that run: **`450fa2deada5b4222039473eb2bec4f012b9e09b754c7d70d75a0f12430f8ec2`**; frozen authoritative V166 Drums SHA256 remains **`05890ac9cad62eacf0099c962b137a458228811a85b8ea828bb15f238d2c1e50`**.
- Across all **1452** frozen V166 events and **4356** persisted option rows, current selected-step changes were **0**; frozen winner recomputation mismatches **0**; stored historical score recomputation mismatches **0**; inconsistent repeated historical-support steps **0**; changed-decision examples empty.
- Historical option rows covered **1617/1805 lattice steps = 89.58448753462604%**. **188 lattice steps remain uncovered*, so the strict gate does not authorize use of the drifted Drums context for one-shot SplitMySong generation.
- Continuous drift on covered evidence was very small but nonzero: maximum absolute shared-support delta **`0.0001594903414565696`** and maximum absolute event-step-score delta **`1.5949034145645857e-05`**. Private report SHA256 printed by the run: **`3c49f2a87cdf1ca47161ed19a4eb47406cc542b8310f70f508073d7ee9ee8f87`**; no report/audio/stem artifact was uploaded.
- The workflow used no private SplitMySong audio. Basic Pitch was installed only for historical dependency parity but the checker reports `basicPitchImported=false` and `pitchInferenceInvoked=false`; no candidate was generated, no scorer/reference was read, and reference-facing score calls remain 0.
- **Next safe step:** determine whether the 188 uncovered lattice steps can be filled from other already-frozen reference-blind artifacts that provably share the exact V166 timebase and historical shared-onset context. Do not weaken the full-coverage rule and do not run the one-shot SplitMySong candidate generator unless a new pre-registered gate reaches PASS.
- **Project Progress Score remains 60%; Test Score remains NOT RUN; SplitMySong Basic Pitch attempts remain 0; V168 reference-facing score calls remain 0.** No GPU/CUDA/Modal, `main`, or Production change occurred.

## 2026-09-01 continuation checkpoint — uncovered-step artifact provenance triage
- Re-fetched the branch checkpoint before continuing and preserved the strict 1805/1805 shared-context coverage gate; no acceptance threshold or historical stem identity was weakened.
- V167 recovery/I005 artifacts do not provide new historical `stepSelection.sharedSupport` coverage. `build_upstream_recovery_variants_v167.py` compacts inherited events to grid coordinates and creates recovery events with recovery evidence, but it does not persist a new `stepSelection` object or historical shared-support value for those additions. The rich I005 construction base therefore inherits the V166 evidence surface rather than filling the 188 uncovered lattice steps.
- V167 Iteration 002 is not admissible as independent reference-blind support evidence for this gate. Its frozen receipt states `referenceFacingScore=true` and `referenceSelectedWholeRuleOnly=true`; although the transform itself did not read the professional reference and did not select individual event alternatives, the whole-stream timing rule was selected through single-song reference-facing calibration. Do not use I002/I003/I004/I005 calibration outputs to backfill missing historical shared-support rows.
- V165 is reference-blind but uses timebase SHA256 **`eaef13457f7a2d357d9f288afdeb8b9d0364f85be29b367247245cf9ed636426`**, not the authoritative V166 timebase SHA256 **`899746d3048d239bc0032375d412a109ea04b055df19df1b7b08dc3e73aa5ca0`**. It is therefore excluded from the exact-timebase coverage union.
- V163 is likewise reference-blind but uses timebase SHA256 **`bd36e645c9777719ecbbe9602fe6b25b920ccfee11204c26554d34c314d8f78d`**, so it also cannot fill exact V166 lattice rows.
- No new safe alternate artifact has yet been identified. The 188-step gap remains unresolved and the preregistered shared-context checker remains **FAIL_CLOSED**.
- Next safe step is a repository-only provenance/coverage audit limited to artifacts that can independently prove: exact V166 timebase identity, pre-reference/reference-blind generation of the relevant shared-support evidence, and exact agreement with V166 on overlapping `sharedSupport` rows. Any reference-selected V167 calibration artifact, different-timebase CPU lineage artifact, scorer output, professional reference, or inferred/extrapolated support value must be excluded.
- No SplitMySong Basic Pitch inference, candidate generation, scorer/reference access, or reference-facing score call occurred in this triage. No GPU/CUDA/Modal, `main`, Production, V168 policy/scorer/validator, or holdout state changed. **Project Progress Score remains 60%; Test Score remains NOT RUN; SplitMySong Basic Pitch attempts remain 0; V168 reference-facing score calls remain 0.**
