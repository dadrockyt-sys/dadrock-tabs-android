...
Active phase: **V147 Phase C REAL-AUDIO ARTIFACT-FIRST CONSTRUCTION = GO. Exactly one immutable candidate was constructed from the exact historical audio under the frozen protocol. All candidate invariants, deterministic replay, render/PDF fidelity, and no-reference/no-score safety gates passed. The one-use execution workflow still exists only long enough to be deleted/sealed. Phase D/reference/gold scoring remains UNAUTHORIZED.**

## Permanent safety / fixed protocol
- Work only on `v143-contextual-prune-lobo`; never modify/merge `main` or Production.
- `/ai-tab` frontend, Bass/Lead, `freezeReady=false`, main, Production untouched.
- Phase C authorization was artifact-first construction only; Phase D/reference/gold scoring is not authorized.
...
- Accepted scores remain **35.4 / 6.7 / 5.5 / 5.8 / 100 / 100** because Phase C performed no scoring and no promotion.
...
- Phase-C run materialized accepted family #10 and verified 1144 / `4e6f9f...` before historical audio checkout, made calibration reference files unreadable, sparse-checked out only the exact historical source, then verified byte count + SHA before decode.

## V147 Phase C real-audio execution — GO
- One-use workflow execution commit `be3dac43fdb559c32ee782b8f4b827822b9cc083`.
...
- Bundled decoder ffmpeg `7.0.2-static`.
...
- HPSS margin `(1.0,6.0)`.
- CQT shape `[243,36425]`; hop `128`; 48 bins/octave; fmin MIDI `40` / `82.4068892282175 Hz`; 243 bins; MIDI-bin range `40.0..100.5`.
...
- Candidate file `candidate.json`: 280933 bytes; SHA256 `c0215690d5bfd9d2d47b8784eee886e942fbd28c499f25c643635c45ff7a9636`.
- Decisions file: 954471 bytes; SHA256 `3ec6c42730bf571c29258eca131c4e32da257c1ac6073e5319073818e8ac49b9`.
- Construction proof file: 4589 bytes; SHA256 `16b7d6a258e07900bf033a922b4239c6270900221aa60f433cacd61b9a5bb448`.
- Phase-C evidence file: 6576 bytes; SHA256 `135e655e915ef4008e0544601a382b54c4104038f053ca5f0ffb6f2b121e193e`.
- PDF render evidence: 181386 bytes; SHA256 `4d25a8346a40009ec5bdaf34c89f5d09e41ba9504e4264b0fd7cb21d7c25e4b9`.
- Raw-audio identity file SHA256 `4ed7880b99fdeab8a1830efdbe3519024fcee0bc182213e18151ec0ad491c612`.
- Pinned environment file SHA256 `14bcc9531c91cdcf5388a0b6c0f996907f46e039627b39adad051aa23b906c69`.

### Observational construction metrics — NOT SCORES
- Events considered / usable evidence: `1144 / 1144`.
- Insufficient-frame events `0`.
- Pitch changes total **247**: down-one `137`, up-one `110`.
- V147 reasons: `alternate-supported=247`, `original-best=757`, `alternate-fundamental-too-weak=88`, `alternate-score-margin-too-small=49`, `alternate-fundamental-margin-too-small=3`.
- Weak fail-closed `140`; ambiguous fail-closed `0`; malformed fail-closed `0`.
- Onset-group fingering fail-closed `0`.
- Position identity violations `0`.
- Timing/metadata invariant violations `0`.
- Input mutation violations `0`.
- Order violations `0`.
- Pitch-delta violations `0`.
...
- Determinism replay proof payload SHA is identical: `d749d911ef79be75c8824ba89a5ed00b90f28c88ffb1e0149c4d82b34aaa0d62`.
- `deterministic=true`.
...
- Artifact name `v147-phase-c-real-audio-33038518285`.
- Artifact ID `9633030568`.
- Artifact size `179265` bytes; 13 evidence files; audio itself was not uploaded.
- GitHub artifact digest independently confirmed as SHA256 `ea4c8b3a63b8798ec7bd3a88b1b16964d341064eac231266edc5d4e92a1cb68b`.
- Artifact retention expires `2026-09-26T04:13:57Z` unless separately preserved later under an authorized protocol.

## Interpretation boundary
- **Phase C GO means only that one real-audio-derived candidate was safely and deterministically constructed under the frozen protocol without reference/gold access.**
- It does **not** establish musical improvement, because no accuracy score or accepted-baseline comparison was run.
- Accepted baseline scores therefore remain unchanged.

## EXPLICIT NEXT STEPS
1. Delete/seal `.github/workflows/v147-phase-c-real-audio-once.yml`; do not rerun it.
2. Checkpoint the workflow deletion/seal commit while preserving all immutable candidate/evidence identities above.
3. **STOP before Phase D/reference scoring.** No reference/gold may be opened and no candidate score may be calculated without a separately frozen Phase-D protocol and explicit authorization.

## Current stop point
- V147 A GO/SEALED; V147 B GO/SEALED; Phase-C pre-audio GO/SEALED; **V147 Phase C real-audio construction = GO**.
