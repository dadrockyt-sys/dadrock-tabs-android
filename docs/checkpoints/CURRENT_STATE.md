...
## Original immutable evidence artifact
...
- GitHub artifact digest SHA256 `ea4c8b3a63b8798ec7bd3a88b1b16964d341064eac231266edc5d4e92a1cb68b`.
- Actions retention expiry `2026-09-26T04:13:57Z`; durable branch preservation below removes dependence on that expiry for the replay evidence.

## Durable V147 replay preservation — COMPLETE / SEALED
- Fresh V147 replay preservation was required because the V144 preserved data belongs to a different pipeline/front end and is historical only.
- Durable path: `debug/v147-phase-c-real-audio/preserved-run-33038518285/`.
- Successful archival workflow run `33039052920`, job `98408266298`: **SUCCESS**.
- Preservation commit: **`5ad9b4eba040219e89be9286587756d81f5a9015`** (`debug: preserve V147 Phase C replay evidence`).
- Preservation manifest: `debug/v147-phase-c-real-audio/preserved-run-33038518285/preservation-manifest.json`; Git blob **`9f67507b448eb3a36f6e5d2d96572af425c42cb5`**.
- One-use archival workflow `.github/workflows/v147-phase-c-preserve-replay-once.yml` deleted/sealed at commit **`2ca2e9ebcdff768869d6a2935f909a755b3dfcfa`**.
- Manifest schema `14741`; classification `v147-phase-c-durable-reference-free-replay-preservation`.
- Exactly 13 original artifact files are hash/byte-bound in the manifest; `decisionCount=1144` and candidate event SHA remains `ca35c3492295a3079c17c35124df7a483166315e85649e95ded095c6c06b2b77`.
- Preserved core identities include:
  - `decisions.json` `3ec6c42730bf571c29258eca131c4e32da257c1ac6073e5319073818e8ac49b9`
  - `candidate.json` `c0215690d5bfd9d2d47b8784eee886e942fbd28c499f25c643635c45ff7a9636`
  - `construction-proof.json` `16b7d6a258e07900bf033a922b4239c6270900221aa60f433cacd61b9a5bb448`
  - `phase-c-evidence.json` `135e655e915ef4008e0544601a382b54c4104038f053ca5f0ffb6f2b121e193e`
  - `pdf-render-evidence.json` `4d25a8346a40009ec5bdaf34c89f5d09e41ba9504e4264b0fd7cb21d7c25e4b9`
  - frozen analysis `b6bce95abeb83b9c9839ed649adc51368a67720a5b072a8ea3717606e3825103`
  - freeze manifest `882d8da86d500c68510d2b21a0721588072244d15d6f71cfe4bd3f093b5abbd8`
  - PDF fidelity report `3d11f039a197df964a22c6ed085957d9277e1a814fe5b9fbadad79252e87379a`
  - raw-audio identity metadata `4ed7880b99fdeab8a1830efdbe3519024fcee0bc182213e18151ec0ad491c612`
  - pinned environment `14bcc9531c91cdcf5388a0b6c0f996907f46e039627b39adad051aa23b906c69`
  - preflight output `99211766cd16460d96d6daae9f3863e99c0d7a0f5a55a62020b00377b9832953`
  - execution output `7e07d371eb29e5b525a0e4a2844ca086ae8c343899266f53dd8c7d533e2cebe7`
  - artifact identities `26fa6529d748c706db2b9df53342988c8a5fd22abd4520eccf7c5b2104cf6200`
- Preservation contains **no raw audio, no normalized PCM, and no full CQT matrix**. It does preserve per-event CQT-derived candidate evidence/frame indices in `decisions.json`.
- Future V147 decision/fingering/candidate-validation tests can replay reference-free from this bundle without reading the song and without Modal/L4/GPU usage.
- A future experiment that changes/recomputes the audio front end itself still requires separate audio-access authorization because the full CQT/PCM was intentionally not regenerated after the Phase-C result.
- Preservation itself read no audio, recomputed no HPSS/CQT, reconstructed no candidate, opened no reference/gold, ran no score, and used no Modal/GPU.
- A later redundant archival run `33039197100` failed closed at the destination-exists guard before artifact download; it made no data changes and confirms overwrite protection.
...
## Phase D reference-free resumption — HISTORICAL PRE-FREEZE STATE
...
- Safety boundary remained intact: **no gold/reference opened, no scoring run, no Modal/L4/GPU run, no candidate variant/search, no Production integration**.
- Authorized task was only to design and freeze the Phase-D reference-free scorer/evaluator, fixed artifact contract, evaluation order, fail-closed rules, and exact STOP/GO gates using preserved non-reference evidence.
- Fresh explicit authorization was required after the Phase-D preregistration freeze before any reference/gold scoring; the latest freeze below adds unresolved technical GO gates that must also be cleared first.

## FRESH-CHAT HANDOFF — HISTORICAL PRE-FREEZE PLAN
...
## EXPLICIT NEXT STEPS — SUPERSEDED BY LATEST PHASE-D FREEZE BELOW WHERE INCONSISTENT
...
## Current stop point — SUPERSEDED BY LATEST PHASE-D FREEZE BELOW
...
- Phase D reference-free design/freeze was active at this earlier stop point; see the latest freeze below.
...
- Gold/reference content remained unopened. No calibration score, workflow execution, Modal, L4, CUDA, GPU work, candidate search, alternate candidate, or Production integration was run.
...
- Therefore the first Phase-D full calibration score remained **BLOCKED** until an existing full evaluator plus candidate adapter contract could be proven from code/docs/non-reference evidence. Do not invent or reconstruct a new scorer after candidate construction.

## Phase-D preregistration freeze — COMPLETE / NO-GO — 2026-08-27 UTC
- Frozen preregistration path: `debug/v147-phase-d-reference-free/phase-d-preregistration-no-go.json`.
...
- Immutable candidate is bound to:
  - path `debug/v147-phase-c-real-audio/preserved-run-33038518285/candidate.json`
  - Git blob `3091d4b1468260746d6629af67b7b92599d5134e`
...
## V148 Phase B first construction attempt — FAILED CLOSED BEFORE CONSTRUCTION / RECOVERY FROZEN — 2026-08-27 UTC
- Original one-use construction workflow arming commit: `86ce4cf2a4e06048cca4cd65f1ddf199c840f2a6`.
- GitHub Actions run `33043698461`, job `98422759855`: **FAILURE** at step `Construct exactly one frozen V148 candidate`.
- The one-use attempt sentinel was correctly consumed first and durably committed at **`3fa9175a2a9b334dda48f63877ee9ef7e9ef703d`**; current sentinel blob `52321ef300e7c54ea10d91b9ef98e6f287215f03`, status `CONSUMED_BEFORE_CONSTRUCTION`.
- Exact failure from job logs: `ModuleNotFoundError: No module named 'modal'` while importing `modal.v147_phase_c_artifact_support` at module initialization in `validation/v148_singleton_only/construct_once.py`.
- This was an infrastructure/module-discovery failure only. Python exited at import time **before accepted-family reconstruction, before preserved V147 candidate/decision input reads, and before construction logic could execute**.
- Candidate output persisted: **NO**. V148 candidates constructed: **0**. Reference-facing score calls: **0**.
- No Gold/reference/professional image content was opened; no audio was read/decoded; no HPSS/CQT, Modal/L4/GPU, scorer, search, retuning, main/Production modification, or promotion occurred.
- The original frozen scientific constructor remains unchanged at blob **`bb43464f48cc8e0eade0f9e98229c859cb117986`**.
- Infrastructure-only launcher `validation/v148_singleton_only/recover_import_path_once.py` is frozen at blob **`0bc6ab8795539eaab084cae5e60680ac0a2cba66`**. Its only action is to prepend the repository root to Python `sys.path` and delegate to the unchanged constructor; it contains no musical/candidate logic.
- Recovery preregistration: `debug/v148-singleton-only/import-path-recovery-preregistration.json`; Git blob **`c5825e8a345a52c2aa15f38527334d24eef409af`**; freeze commit `f50c6e862a1d73bf26ff8d01824e577e96f687da`.
...
## FRESH-CHAT HANDOFF — V152 SEALED / NEXT TARGET V153 NOT STARTED — 2026-08-27 UTC
- This section is the authoritative resume point requested by the user for a fresh chat. Work remains **only** on branch `v143-contextual-prune-lobo`; do not modify, merge, or promote `main`/Production.
- Handoff basis before this documentation-only append: sealed V152 branch head `b2687bb83a5cc5683bcdda61515339d7924e57b1`; `docs/checkpoints/CURRENT_STATE.md` Git blob `813536e7129e57b7d110a088bda35dfa05aa973f`.
- **Best experimental result so far is V152, sealed.** Candidate canonical event SHA256 `5ebedfb173730bb5e2639e7450841fb113f7db9af2acec19b88e58cca50679e6`; candidate file SHA256 `9b15ab3aa9540438db0750bb11c592a686e87b00b3acba491c80791badd349cb`; exactly **3 changed singleton events / 3 changed onsets / 0 polyphonic changes / 1144 events / 113 measures / 100% PDF fidelity**.
- V152 changed event indices are exactly **`[132, 347, 457]`**. They were chosen reference-free because each survived V151 positive consensus and then had local recurrence favoring the selected note in **both exact-pitch and pitch-class channels**.
...
- Accepted baseline percentages: **35.407 / 6.699 / 5.455 / 5.805 / 100.000 / 100.000**.
- V152 critical mismatches are **1712**, exactly tied with accepted baseline **1712**. V152 therefore fully recovered the mismatch regression and exactly matches baseline on pitch timing, string/fret timing, chord pitch-set, coverage, and PDF fidelity. The only displayed deficit is pitch content: **35.311% vs 35.407%**, a gap of about **0.096 percentage points**.
- Durable V152 score result: `debug/v152-active-recurrence/phase-c-score/score-result.json`; SHA256 **`cc549c6f0a33c0b90648433494ef36a31b5647191058e28b9ea089f12cab7ef4`**; run `33050114109`. V152 score authorization is consumed/sealed; **do not rescore V152**.

### Recommended next scientific phase — V153 reference-free strength ranking
- **V153 has NOT started.** No V153 preregistration, analyzer, candidate, Gold read, or score is authorized by this handoff request. A fresh chat should first read this checkpoint and verify the current branch head before doing anything else.
- Scientific goal: determine whether one of V152's three surviving edits has materially stronger **reference-free positive evidence** than the other two, so the next candidate can make the smallest defensible departure from accepted family #10 and attempt to move from the V152 tie to an actual baseline win.
- Freeze V153 Phase A **before execution**. Population must be exactly the three immutable V152 events **`[132, 347, 457]`**. Do not widen the population and do not inspect Gold/reference or V152 per-event accuracy to choose among them.
- Use only already-preserved reference-free evidence. Recommended strength components are: **(1)** selected-minus-original exact-pitch recurrence support in the same frozen local window, **(2)** selected-minus-original pitch-class recurrence support in that same window, **(3)** two-sided immediate-neighbor voice-leading improvement magnitude, and **(4)** the already-frozen V149/V147 evidence-margin strength (for example nearest/gate excess) only as a deterministic final tie-breaker. Do not recompute audio, HPSS, CQT, or use Modal/GPU.
- Preregister a deterministic ordering/ranking rule before calculating the three-event ranking. Prefer a transparent lexicographic rule over a tunable weighted score. **No threshold sweep, weight tuning, alternate ranking rule, or post-result rule change.** If the preregistered rule does not produce a unique strongest event, fail closed and stop rather than choosing arbitrarily.
- If V153 Phase A yields a unique strongest event, the recommended next boundary is a **separate one-candidate construction phase**: start from accepted family #10 and copy exactly that one corresponding V152 canonical row; preserve every other accepted row exactly. Expected structure: **1144 events / 113 measures / 1 changed singleton event / 1 changed onset / 0 polyphonic changes / one candidate only**, deterministic replay, zero timing/metadata or position-identity violations, and PDF event fidelity `1.0`.
- Construction must remain reference-free: no Gold/reference, no prior per-event score inspection, no candidate variants/search, no alternate top-N subset, no audio/HPSS/CQT, no Modal/GPU, no main/Production changes, and no automatic promotion.
- Only after that one-event candidate is durably persisted and exact byte/canonical/PDF identities are sealed should a **separate one-use Gold calibration score** be considered. Bind exactly one score to that exact candidate identity; no rescore, no alternate candidate, and no post-score retuning.
- Success target for the next scored candidate: **strictly beat the accepted baseline rather than merely tie it**, while preserving the already recovered metrics. In particular: critical mismatches **<1712** and/or a genuinely improved calibration vector, with special attention to closing or reversing the remaining pitch-content gap without sacrificing pitch timing, string/fret, chord pitch-set, coverage, or PDF fidelity.

### Fresh-chat safety / authorization boundary
- Treat all V148–V152 reference-facing score authorizations as **consumed**. The user's present request authorized **documentation of next steps only**, not V153 execution.
- Do **NOT** read/open Gold/reference again, inspect reference-facing per-event correctness, construct a V153 candidate, score another candidate, search variants, tune thresholds/weights/filters, recompute audio/HPSS/CQT, use Modal/L4/GPU, touch `main`/Production, or promote anything unless the user gives fresh explicit authorization for the corresponding separately frozen phase.
- Any stale V152 construction/recovery workflow files or failed infrastructure attempts are historical only; **do not rerun them**. V152 already has exactly one sealed candidate and exactly one completed Gold score.
- Recommended fresh-chat opening sequence: **(1)** read `docs/checkpoints/CURRENT_STATE.md`; **(2)** verify branch `v143-contextual-prune-lobo` and current head; **(3)** confirm V152 sealed result and consumed score boundary; **(4)** on fresh user authorization, freeze V153 Phase A reference-free ranking exactly as above; **(5)** checkpoint before and after every phase; **(6)** stop at each construction/scoring authorization boundary.
