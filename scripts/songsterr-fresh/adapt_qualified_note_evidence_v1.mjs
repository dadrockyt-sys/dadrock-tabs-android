...
if (!contextArg || !evidenceArg || !outputArg) {
  throw new Error(
    'Usage: adapt_qualified_note_evidence_v1.mjs <context.json> <qualified-evidence.json> <output.json>',
  );
}
...
const output = {
  ...adapted,
  integration: {
    contract: 'songsterr-fresh-qualified-note-evidence-adapter-bridge-v1',
    version: 1,
    referenceBlind: true,
