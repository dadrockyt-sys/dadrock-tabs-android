...
def extract_candidates(
    ...
    for index in range(1, len(profile) - 1):
        ...
        if value < left or value < right or value < CANDIDATE_FLOOR_DB:
            continue
    ...
    output = {
        ...
        "diagnostics": {
            **summarize(onsets),
            ...
            "durationEvidence": {
                "authority": "none-in-pitch-analyzer",
                "resolvedCount": 0,
        ...
        "provenance": {
            ...
            "note": "Guarded-range CPU pitch evidence only; duration is intentionally delegated to the dedicated release-evidence stage; not instrument-isolated and not an accuracy score.",
        },
    }
